    ...
    <section id="top" className="relative overflow-hidden pt-28 pb-20 lg:pt-36 lg:pb-28">
      ...
      <div className="mx-auto grid max-w-7xl items-center gap-12 px-5 lg:grid-cols-2 lg:px-8">
        <div className="animate-fade-up text-white">
          <div className="inline-flex items-center gap-2 rounded-full bg-white/15 px-3.5 py-1.5 text-xs font-medium backdrop-blur-md ring-1 ring-white/30">
            <Sparkles className="h-3.5 w-3.5" />
            India's first hyperlocal personal delivery
          </div>
          <h1 className="mt-5 font-[Sora] text-4xl font-extrabold leading-[1.05] sm:text-5xl lg:text-6xl">
            Forgot something?
            <br />
            <span className="text-white/90">We deliver it</span>{" "}
          ...
          <p className="mt-5 max-w-xl text-base text-white/90 sm:text-lg">
            ...
            essentials to your doorstep in <strong>30–90 minutes</strong>. Because
          ...
          <div className="mt-10 flex flex-wrap gap-x-8 gap-y-3 text-sm text-white/85">
            ...
            <div className="flex items-center gap-2">
              <span className="rounded-full bg-white/20 px-2 py-0.5 text-xs">★ 4.9</span>
              Verified riders
            </div>
          </div>
        </div>
          ...
          <div className="rounded-3xl bg-white/10 p-6 backdrop-blur-xl ring-1 ring-white/30 shadow-glow">
            ...
            <div className="mt-2 grid grid-cols-3 gap-2 text-center text-white">
              <div className="rounded-xl bg-white/15 p-3 backdrop-blur-md">
                <div className="font-[Sora] text-lg font-bold">30m</div>
                <div className="text-[10px] uppercase tracking-wider opacity-80">Avg ETA</div>
              </div>
              <div className="rounded-xl bg-white/15 p-3 backdrop-blur-md">
                <div className="font-[Sora] text-lg font-bold">10k+</div>
                <div className="text-[10px] uppercase tracking-wider opacity-80">Deliveries</div>
              </div>
              <div className="rounded-xl bg-white/15 p-3 backdrop-blur-md">
                <div className="font-[Sora] text-lg font-bold">4.9★</div>
                <div className="text-[10px] uppercase tracking-wider opacity-80">Rating</div>
              </div>
            </div>
          </div>
        </div>
